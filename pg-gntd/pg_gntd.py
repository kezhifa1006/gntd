...
class PGGNTD(object):
    def __init__(self, state_dim, action_dim, max_action, action_space, lr, damping, pi, momentum=False, discount=0.99, tau=0.02, alpha=0.2, policy_freq=10, ql_type='dqn'):
    ...
    def train(self, replay_buffer, batch_size=256):
        ...
        qf_tmp = self.tmp_critic(state, action) 
        ...
        return qf_loss.detach().cpu().item(), qf.mean().cpu().detach().item()
